...
export class CheckoutPaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    loadStripe('pk_test_51PJGsXD14TgwAQjpUn8Co2uCP4HbesbywKf541uhCcem4qspVYc9ujgJt3ubBkT5rHgG8wvs4yvtF9l4cuLYFj0i00apkMzVFP')
      .then(stripe => {
        this.stripe = stripe;
  ...
  private async confirmPaymentWithStripe(basket: Basket | null) {
    ...
    if (!result) throw new Error('Problem attempting error with stripe');
    return result;
  }
